...
Usando Flask-DebugToolbar
----------------------------------

SQLAlchemy-Wrapperes totalmente compatible con with `Flask-DebugToolbar <https://flask-debugtoolbar.readthedocs.org/en/latest/>`_, pero necesita un paso extra para funcionar.
